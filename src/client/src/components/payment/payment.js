...
import { PaymentSuccess, PaymentError } from "./payment_screens";
...
import { TransferMoney, repeateTransferMoney } from "../../actions/payments";
...
const mapDispatchToProps = dispatch => ({
   ...
   * Повторить платеж
   */
  onRepeatPaymentClick: () => dispatch(repeateTransferMoney())
});
